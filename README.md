...
[![version](https://img.shields.io/badge/version-2.1.4-c8a86c?style=flat-square)](https://github.com/shaolonger/komari-ran-theme/releases)
...
前往 [Releases](https://github.com/shaolonger/komari-ran-theme/releases) 下载最新 zip,在 Komari 后台 → 主题管理 → 上传主题 应用。
...
| `version_tag` | string | `v2.1.4` | 页脚显示的版本标识 |
