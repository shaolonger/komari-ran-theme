...
[![version](https://img.shields.io/badge/version-2.1.0-c8a86c?style=flat-square)](https://github.com/saladinxp/komari-ran-theme/releases)
...
| `version_tag` | string | `v2.1.0` | 页脚显示的版本标识 |
